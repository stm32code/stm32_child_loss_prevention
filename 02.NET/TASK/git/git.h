...
#endif
// 设备信息
#define PROID "22-1-device"															 // 产品ID
#define DEVID "22-1-device" // 设备ID
#define AUTH_INFO "22-1-device"						 // 鉴权信息
// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/221/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/221/test2" // 需要发布的主题
